...
{	
	/*
	 * Module 03, exercise #3: Change the design to ensure uniqueness of Card instances through
	 * the use of the Flyweight Design Pattern.
	 */
	
	/**
	 * A data structure that keeps a list of Card instances, stored in a static field.
	 * Indexed by suit, then by rank
	 */
	private static final Card[][] CARDS = new Card[Suit.values().length][];
	
	/**
	 * A static factory method that returns the unique Card object that corresponds to the input parameter.
	 */
	static
	{
	...
	/**
	 * A private constructor for the Flyweight, so clients cannot control the creation of objects.
	 * @param pRank The rank of card
	 * @param pSuit The suit of card
	 */
